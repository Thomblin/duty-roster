...
Copy an example configuration file from [test/config.toml](test/config.toml) into the project directory (or where the executable is lcoated). Execute the program. It will create a csv file with the schedule.
